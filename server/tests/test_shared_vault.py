...
from aeon.core.chat_cli import build_response, retrieve_context
from aeon.core.shared_vault import load_startup_context, search_shared_vault
...
def test_chat_prompt_receives_master_vault_startup_context(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr("aeon.core.chat_cli.generate_chat", fake_generate_chat)
