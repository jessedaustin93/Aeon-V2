...
from aeon.core.embeddings import clear_cache, cosine_similarity, get_embedding
...
class TestGetEmbedding:
    ...
    def test_returns_vector_on_success(self):
        ...
        with patch("aeon.core.embeddings.urllib.request.urlopen", return_value=FakeResp()):
    ...
    def test_returns_none_on_connection_error(self):
        cfg = _cfg()
        with patch("aeon.core.embeddings.urllib.request.urlopen", side_effect=OSError("refused")):
    ...
    def test_connection_error_opens_short_circuit(self):
        ...
        with patch("aeon.core.embeddings.urllib.request.urlopen", side_effect=OSError("refused")) as mock_urlopen:
    ...
    def test_model_name_sent_when_configured(self):
        ...
        with patch("aeon.core.embeddings.urllib.request.urlopen", side_effect=fake_urlopen):
...
class TestConsolidationEmbeddingPath:
    def test_embedding_consolidates_semantic_duplicates(self, tmp_path):
        ...
        from aeon.core.consolidate import consolidate_memories
        from aeon.core.embeddings import clear_cache
        clear_cache()
        ...
        with patch("aeon.core.consolidate.get_embedding", side_effect=fake_embed):
    ...
    def test_jaccard_fallback_when_embeddings_unavailable(self, tmp_path):
        ...
        with patch("aeon.core.consolidate.get_embedding", return_value=None):
            result = consolidate_memories(config=cfg)
    ...
    def test_no_consolidation_below_embedding_threshold(self, tmp_path):
        ...
        with patch("aeon.core.consolidate.get_embedding", side_effect=lambda t, c:
    ...
    def test_embedding_disabled_uses_jaccard_only(self, tmp_path):
        ...
        with patch("aeon.core.consolidate.get_embedding") as mock_emb:
            result = consolidate_memories(config=cfg)
