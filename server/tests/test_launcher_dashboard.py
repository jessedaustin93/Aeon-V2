...
from aeon.core.dashboard import DashboardController
from aeon.core.launcher_config import load_launcher_config
from aeon.core.runner import run_forever
from aeon.core.runtime import read_json, runner_status_path, runner_stop_path
...
def test_dashboard_image_upload_returns_media_record(tmp_path):
    ...
    with patch("aeon.core.media.generate_image_description", return_value="A dashboard image."):
...
def test_dashboard_chat_accepts_image_attachment(tmp_path):
    ...
    with patch("aeon.core.media.generate_image_description", return_value="A small image attached in chat."):
