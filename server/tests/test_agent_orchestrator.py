...
from aeon.core import AgentNode, AGENT_ROLES, Config, Orchestrator, ingest
...
def test_executor_role_with_task(cfg):
    ...
    from aeon.core import reflect
    reflect(cfg)

    from aeon.core import TaskStore
