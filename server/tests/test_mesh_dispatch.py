...
from aeon.core.mesh_dispatch import (
    MeshClient,
    MeshDispatchError,
    build_music_command,
    manage_music,
)
from aeon.core.security import AuditLog
...
def test_do_music_command_dispatches_through_manage_music(tmp_path, capsys):
    from aeon.core.chat_cli import ChatOptions, TerminalChatApp
...
def test_build_response_dispatches_music_when_auto_approve(tmp_path, monkeypatch):
    from aeon.core import chat_cli
    cfg = Config(tmp_path)
    cfg.mesh_auto_approve = True
    calls = []
