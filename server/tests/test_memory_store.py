...
from aeon.core import Config, ingest, reflect, search
from aeon.core.memory_store import _score_importance, _vault_note_path
...
def test_direct_core_write_raises_error(cfg):
    ...
    from aeon.core.exceptions import CoreMemoryProtectedError
    from aeon.core.memory_store import _write_markdown
...
def test_linker_skips_core_vault_files(cfg):
    ...
    from aeon.core.linker import _update_markdown_links
