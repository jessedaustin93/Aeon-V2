...
from aeon.core import Config, ingest, reflect
from aeon.core.decision import DecisionStore, select_next_task
from aeon.core.memory_store import _vault_note_path
from aeon.core.simulate import SimulationStore, simulate_action
from aeon.core.tasks import TaskStore, create_tasks_from_reflection
...
def test_simulation_does_not_execute_commands(cfg_with_reflection):
    ...
    import aeon.core.simulate as sim_module
    import ast, inspect
